...
import static com.tuhin.newsapp.MainActivity.entertainment_url;
...
public class Entertainment extends Fragment {
    ...
    ViewPager2 EntertainmentViewPager2;
    ProgressBar EntertainmentProgress_Bar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        EntertainmentViewPager2 = view.findViewById(R.id.EntertainmentViewPager2);
        EntertainmentProgress_Bar = view.findViewById(R.id.EntertainmentProgress_Bar);
        EntertainmentViewPager2.setVisibility(View.INVISIBLE);
...
//                    recyclerView.setVisibility(View.VISIBLE);
                    EntertainmentViewPager2.setVisibility(View.VISIBLE);
                    EntertainmentProgress_Bar.setVisibility(View.INVISIBLE);
                    logData();
                    callAdapter();
    ...
    public void callAdapter(){
        ...
        EntertainmentViewPager2.setAdapter(adapter);
//        viewPager2.setClipToPadding(true);
//        viewPager2.setClipChildren(false);

        EntertainmentViewPager2.setOffscreenPageLimit(1);
//        viewPager2.getChildAt(0).setOverScrollMode(View.OVER_SCROLL_NEVER);
        ...
        EntertainmentViewPager2.setPageTransformer(transformer);
    }
