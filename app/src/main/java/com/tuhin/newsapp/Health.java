...
import static com.tuhin.newsapp.MainActivity.health_url;
...
public class Health extends Fragment {
    ...
    ViewPager2 HealthViewPager2;
    ProgressBar HealthProgress_Bar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        HealthViewPager2 = view.findViewById(R.id.HealthViewPager2);
        HealthProgress_Bar = view.findViewById(R.id.HealthProgress_Bar);
        HealthViewPager2.setVisibility(View.INVISIBLE);
...
//                    recyclerView.setVisibility(View.VISIBLE);
                    HealthViewPager2.setVisibility(View.VISIBLE);
                    HealthProgress_Bar.setVisibility(View.INVISIBLE);
                    logData();
                    callAdapter();
    ...
    public void callAdapter(){
        ...
        HealthViewPager2.setAdapter(adapter);
//        viewPager2.setClipToPadding(true);
//        viewPager2.setClipChildren(false);

        HealthViewPager2.setOffscreenPageLimit(1);
//        viewPager2.getChildAt(0).setOverScrollMode(View.OVER_SCROLL_NEVER);
        ...
        HealthViewPager2.setPageTransformer(transformer);
    }
