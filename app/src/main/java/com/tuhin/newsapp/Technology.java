...
import static com.tuhin.newsapp.MainActivity.technology_url;
...
public class Technology extends Fragment {
    ...
    ViewPager2 TechnologyViewPager2;
    ProgressBar TechnologyProgress_Bar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TechnologyViewPager2 = view.findViewById(R.id.TechnologyViewPager2);
        TechnologyProgress_Bar = view.findViewById(R.id.TechnologyProgress_Bar);
        TechnologyViewPager2.setVisibility(View.INVISIBLE);
...
//                    recyclerView.setVisibility(View.VISIBLE);
                    TechnologyViewPager2.setVisibility(View.VISIBLE);
                    TechnologyProgress_Bar.setVisibility(View.INVISIBLE);
                    logData();
                    callAdapter();
    ...
    public void callAdapter(){
        ...
        TechnologyViewPager2.setAdapter(adapter);
//        viewPager2.setClipToPadding(true);
//        viewPager2.setClipChildren(false);

        TechnologyViewPager2.setOffscreenPageLimit(1);
//        viewPager2.getChildAt(0).setOverScrollMode(View.OVER_SCROLL_NEVER);
        ...
        TechnologyViewPager2.setPageTransformer(transformer);
    }
