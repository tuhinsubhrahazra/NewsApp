...
import static com.tuhin.newsapp.MainActivity.sports_url;
...
public class Sports extends Fragment {
    ...
    ViewPager2 SportsViewPager2;
    ProgressBar SportsProgress_Bar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        SportsViewPager2 = view.findViewById(R.id.SportsViewPager2);
        SportsProgress_Bar = view.findViewById(R.id.SportsProgress_Bar);
        SportsViewPager2.setVisibility(View.INVISIBLE);
...
//                    recyclerView.setVisibility(View.VISIBLE);
                    SportsViewPager2.setVisibility(View.VISIBLE);
                    SportsProgress_Bar.setVisibility(View.INVISIBLE);
                    logData();
                    callAdapter();
    ...
    public void callAdapter(){
        ...
        SportsViewPager2.setAdapter(adapter);
//        viewPager2.setClipToPadding(true);
//        viewPager2.setClipChildren(false);

        SportsViewPager2.setOffscreenPageLimit(1);
//        viewPager2.getChildAt(0).setOverScrollMode(View.OVER_SCROLL_NEVER);
        ...
        SportsViewPager2.setPageTransformer(transformer);
    }
