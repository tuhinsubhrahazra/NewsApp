...
import static com.tuhin.newsapp.MainActivity.science_url;

public class Science extends Fragment {

    public static ArrayList<News> newsArrayList  = new ArrayList<>();
    RequestQueue requestQueue;
    ViewPager2 ScienceViewPager2;
    ProgressBar ScienceProgress_Bar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ScienceViewPager2 = view.findViewById(R.id.ScienceViewPager2);
        ScienceProgress_Bar = view.findViewById(R.id.ScienceProgress_Bar);
        ScienceViewPager2.setVisibility(View.INVISIBLE);
...
//                    recyclerView.setVisibility(View.VISIBLE);
                    ScienceViewPager2.setVisibility(View.VISIBLE);
                    ScienceProgress_Bar.setVisibility(View.INVISIBLE);
                    logData();
                    callAdapter();
    ...
    public void callAdapter(){
        ...
        ScienceViewPager2.setAdapter(adapter);
//        viewPager2.setClipToPadding(true);
//        viewPager2.setClipChildren(false);

        ScienceViewPager2.setOffscreenPageLimit(1);
//        viewPager2.getChildAt(0).setOverScrollMode(View.OVER_SCROLL_NEVER);
        ...
        ScienceViewPager2.setPageTransformer(transformer);
    }
